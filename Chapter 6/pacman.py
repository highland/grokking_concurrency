...
def compute_game_world() -> None:
    ...
    print(
        f"Pacman doing: {WORLD_STATE.get('user_input', 'user input was not provided')}")
...
def render_next_screen() -> None:
    ...
    print(
        f"Rendering pacman by user input: {WORLD_STATE.get('user_input', 'not provided')}")
    print(
        f"Rendering ghost1 in position {WORLD_STATE.get('ghost1_position', 0)}")
    print(
        f"Rendering ghost2 in position {WORLD_STATE.get('ghost2_position', 0)}")
    print(
        f"Rendering ghost3 in position {WORLD_STATE.get('ghost3_position', 0)}")
    time.sleep(0.5)
